...
create table 1928_showroom.orders(
	...
	# Si tiene descuento de cuanto es , si no tiene null
...
create table 1928_showroom.exchange_benefits(
	...
	points_exchange int,
	#Numero de puntos usados ( Puntos del cliente  - puntos del beneficio)
	id_client int,
...
create table 1928_showroom.turns(
	...
	#Numero que identifica el turno
	date_acquired_turn date,
	#Fecha que se pidio el turno
	date_turn date,
	#Fecha para la cual se saco el turno
	id_client int,
	#Numero del cliente que solicito el turno 
	used_turn boolean,
	#Si concurrio o no al turno solicitado
	primary key(id_turn),
	foreign key (id_client) references 1928_showroom.clients(id_client)
);
...
#prueba de dar permisos
revoke all privileges on *.*
from
	'user_1' @'localhost';

#prueba de quitar permisos
